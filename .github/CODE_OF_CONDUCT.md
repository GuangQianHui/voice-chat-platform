...
本行为准则有多种语言版本。请访问 https://www.contributor-covenant.org/translations 查看其他语言版本。

## 常见问题

### 为什么采用贡献者公约？

我们认为，开放源代码社区应该是一个安全、友好和包容的环境，让任何人都可以贡献。我们采用了贡献者公约，因为我们相信它有助于建设这样的社区。

### 贡献者公约是否意味着我无法表达我的观点？

不是的。贡献者公约禁止的是侮辱、骚扰和其他不可接受的行为。建设性的批评和分歧是受欢迎的，只要以尊重的方式表达。

### 如果我在项目之外遇到不可接受的行为怎么办？

贡献者公约只适用于项目空间。如果您在项目空间之外遇到不可接受的行为，请直接联系相关人员或相关组织。

### 如果我不确定某事是否违反行为准则怎么办？

如果您不确定某事是否违反行为准则，请报告它。项目维护者会审查情况并决定适当的行动。
